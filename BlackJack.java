	...
	// Game starts	
        ...
        // Dealing Cards
           ...
           // Checking if player was dealt Aces     
                while(newGame.player.cardPoint > 21){
                    System.out.println("You just get two Aces! You may want to make one Ace 1 point to keep from busting." );
                ...
                if(newGame.player.cardPoint == 21){
                    ...
                    System.out.println("Wow, Blackjack. Good for you!" ); 
                }
                else{
                    System.out.println("You were dealt: " + newGame.player.cardPoint + " Points.");
                }
        ...
        // Player's turn: Hit or Stand?
              ...
              // Player hits 
                while (typedLine.equals("h")){
                    System.out.println("So you want to hit. You are getting a new card." );
            ...
            // checking player points
                    if (newGame.player.cardPoint > 21){
                        System.out.println("Well, you just bust. Good luck in next round!" ); 
                        break;
                    }
            ...
            // Player stands    
             if(typedLine.equals("s")){
                    System.out.println("So you want to stand. OK. Good luck!" );
       ...
       // Dealer's turn         
           ...
           // If player busts, dealer wins.   
                if(newGame.player.cardPoint > 21){
                    System.out.println("Dealer won. Sorry you just lost " + chipsBet + " chips." );
         ...
         //Dealer draws cards while player standing      
                ...
                if(newGame.dealer.cardPoint >21){
                	...
                	System.out.println("You just won " + chipsBet + " Chips!!!");
                	newGame.player.chips += chipsBet;
                	System.out.println("You have " + newGame.player.chips + " chips left. Good luck!" );
                    }
       ...
       // Time to count money
                if (newGame.player.cardPoint > newGame.dealer.cardPoint) {
                    ...
                    if (newGame.player.chips <= 0){
                        System.out.println("Woops, you lost all chips." );
                        }
                    else{
                        System.out.println("You have " + newGame.player.chips + " chips left. Good luck!" );        
                        }
                ...
                System.out.println("It's a tie. Good you have all money back.");
                System.out.println("You have " + newGame.player.chips + " chips left. Good luck in next round!" );
                }
       ...
       // Checking if player wants to keep playing         
                ...
                if (response.equals("y")){
                	if (newGame.player.chips <= 0) {
                		System.out.println("You have ran out of chips. Never borrow money while gambling. The hotel room has a nice bed ^_~");
